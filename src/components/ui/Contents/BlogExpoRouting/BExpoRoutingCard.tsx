...
const BExpoRoutingCard = () => {
  ...
  return (
    <>
      <Card.Root width="100%" onClick={() => navigate("/blog/expo-routing-basic")} cursor="pointer" _hover={{ transform: 'translateY(-2px)', shadow: 'md' }} transition="all 0.2s">
        <Card.Body>
          <VStack align="start" gap={2}>
            ...
            <Text color="fg.muted" fontSize="sm">Expoの動的ルーティング(クエリ形式との違い)</Text>
          </VStack>
        </Card.Body>
      </Card.Root>
    </>
